                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php if (isset($kycData['aadhar_front'])): ?>
                                    <small><a href="../<?php echo $kycData['aadhar_front']; ?>" target="_blank">View Current</a></small>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php if (isset($kycData['aadhar_back'])): ?>
                                    <small><a href="../<?php echo $kycData['aadhar_back']; ?>" target="_blank">View Current</a></small>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php if (isset($kycData['pan_card'])): ?>
                                    <small><a href="../<?php echo $kycData['pan_card']; ?>" target="_blank">View Current</a></small>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php if (isset($kycData['passbook_check'])): ?>
                                    <small><a href="../<?php echo $kycData['passbook_check']; ?>" target="_blank">View Current</a></small>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
